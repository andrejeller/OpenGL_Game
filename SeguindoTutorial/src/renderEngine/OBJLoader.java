...
public class OBJLoader {
    ...
    public static RawModel loadOBJModel(String fileName, Loader loader) {
        ...
        try {
            ...
            System.err.println("obj nao encontrado");
            e.printStackTrace();
        }
        ...
        verticesArray = new float[vertices.size() * 3]; //NESSA LINHA AQUI LUCAS
        indicesArray = new int[indices.size()];

        int vertexPointer = 0;
        //for (int j = 0; j< vertices.size(); j++){

          //  verticesArray[vertexPointer++] = vertices.get(j).x;
            //verticesArray[vertexPointer++] = vertices.get(j).y;
           // verticesArray[vertexPointer++] = vertices.get(j).z;
